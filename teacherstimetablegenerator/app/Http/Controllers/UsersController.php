...
class UsersController extends Controller
{
    ...
    public function activateUser(Request $request)
    {
        ...
        $activated = true;
        DB::insert("insert into users (name,password,security_question_id,security_question_answer,activated) values('$name','$password','$security_question_id','$security_question_answer','$activated')");
